      ...
      <section className="section pb-0">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <h1 className="font-playfair">Articles</h1>
            ...
            <div className="lg:col-span-1">
              <div className="border border-gray-200 p-6 sticky top-24">
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="#" className="hover:text-gray-600 transition-colors">Productivity</a>
                  </li>
                  <li>
                    <a href="#" className="hover:text-gray-600 transition-colors">Leadership</a>
                  </li>
                  <li>
                    <a href="#" className="hover:text-gray-600 transition-colors">Performance Psychology</a>
                  </li>
                  <li>
                    <a href="#" className="hover:text-gray-600 transition-colors">Strategic Thinking</a>
                  </li>
                  <li>
                    <a href="#" className="hover:text-gray-600 transition-colors">Project Management</a>
                  </li>
                </ul>
                
                <div className="mt-12">
                  <h3 className="text-lg font-playfair mb-6">Subscribe to Newsletter</h3>
                  <p className="text-sm text-gray-700 mb-4">Receive new articles and practical frameworks directly to your inbox.</p>
                  <input 
                    type="email" 
